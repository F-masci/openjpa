...
java -Xmx4G -jar /home/fmasci/Programmi/evosuite-1.2.0.jar \
      -class org.apache.openjpa.lib.util.StringUtil \
      -projectCP target/classes:target/generated-sources:../openjpa-lib/target/classes:../openjpa-kernel/target/classes:../openjpa-jdbc/target/classes:../openjpa-persistence/target/classes:../openjpa-persistence-jdbc/target/classes:$(cat cp.txt) \
      -Dsandbox=false \
      -Dsearch_budget=30 \
